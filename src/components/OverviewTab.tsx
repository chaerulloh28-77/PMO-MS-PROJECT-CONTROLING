...
export const OverviewTab: React.FC<OverviewTabProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Quick Access Project Table: Motivates Immediate Data Input */}
                ...
                return (
                  <tr key={p.id} className="hover:bg-slate-50/60 transition">
                    ...
                    <td className="py-3 px-3">
                      <div className="font-mono text-slate-700">{p.nomorSuratDinas || '-'}</div>
                    ...
                    <td className="py-3 px-4 text-right">
                      <div className="flex items-center justify-end space-x-2">
                        <button
                          ...
                          className="px-2.5 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 rounded-lg text-[11px] font-bold transition cursor-pointer"
                        >
                          Input Fisik
                        </button>
                        <button
                          ...
                          className="px-2.5 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-300 rounded-lg text-[11px] font-bold transition cursor-pointer"
                        >
                          PMO
                        </button>
                      </div>
