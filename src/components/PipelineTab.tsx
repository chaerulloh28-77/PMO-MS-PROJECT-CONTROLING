      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between pb-3 border-b border-slate-200 gap-3">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Papan Kanban tahapan konstruksi, kendala teknis lapangan, dan timeline delivery proyek
          </p>
        </div>

        {/* Search input inside pipeline */}
        <div className="flex items-center space-x-2">
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="w-full bg-white border border-slate-300 rounded-xl pl-9 pr-3 py-2 text-xs text-slate-800 placeholder-slate-400 focus:ring-2 focus:ring-blue-500 shadow-2xs"
            />
          </div>
                ...
                {colProjects.length === 0 ? (
                  ...
                  colProjects.map((p) => {
                    ...
                    return (
                      ...
                      >
                        {/* Card Header: ID & Status Selector */}
