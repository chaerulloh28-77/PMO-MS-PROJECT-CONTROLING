  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Form Body - Scrollable Form with Docked Sticky Action Footer */}
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0 overflow-hidden">
              ...
              <div className="grid grid-cols-3 gap-2.5">
                {PROJECT_AREAS.map((a) => (
                  <button
                    ...
                    type="button"
                    onClick={() => setArea(a)}
                    className={`py-2 px-3 rounded-xl text-xs font-bold border transition cursor-pointer text-center flex items-center justify-center space-x-1.5 ${
                      area === a
          ...
          {/* Action Buttons - Docked & Always Accessible at Bottom */}
          <div className="shrink-0 px-4 sm:px-6 py-3 bg-slate-50 border-t border-slate-200 flex items-center justify-end space-x-3">
            <button
              type="button"
              onClick={onClose}
            ...
            <button
              type="submit"
              className="inline-flex items-center space-x-1.5 px-5 py-2 text-xs font-bold rounded-xl bg-blue-600 hover:bg-blue-700 text-white shadow-xs transition active:scale-[0.98] cursor-pointer"
            >
